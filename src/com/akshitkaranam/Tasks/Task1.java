...
public class Task1 {
    ...
    public static Path ucsUnrestricted(Graph graph, int sourceNodeNumber, int destinationNodeNumber, int taskNumber) {
        ...
        while (!frontier.isEmpty()) {
            ...
            if (!visited.contains(currentNode.getNodeNumber())) {
                ...
                for (Integer neighbouringEdgeInteger : neighbouringEdges) {
                    ...
                    if (taskNumber == 1 || (taskNumber == 2 && newEnergy <= ENERGY_BUDGET)) {
